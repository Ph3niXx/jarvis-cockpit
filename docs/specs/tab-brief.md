...
- **Filtre global "Récent · 24h"** : un bouton flottant en haut à droite du cockpit ("Tout" / "Récent · 24h") ne montre que les éléments apparus depuis moins de 24 heures — top-cards datés <24h et signaux flagués "nouveau" ; les autres restent silencieux. État persistant entre sessions, applicable transversalement aux autres onglets de veille.
