...
- **3 filtres combinables** : Catégorie (auto-détectée depuis les concepts du corpus, préfixée "Tout"), Source (`all / auto / perso` — lit `source_type` en base, les notes perso sont surfaçées correctement), Tri (Récent / Plus lus / A-Z).
